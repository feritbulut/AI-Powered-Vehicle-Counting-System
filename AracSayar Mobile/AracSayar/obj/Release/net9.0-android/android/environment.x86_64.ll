...
@aot_dso_cache = dso_local local_unnamed_addr global [819 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0d123faf1979dc94, ; from name: libaot-AracSayar.so
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	}, ; 57
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x23366c1cece5911c, ; from name: AracSayar.dll.so
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5cf9d04ad9d57083, ; from name: AracSayar
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x72ad8716cf5ecc58, ; from name: libaot-AracSayar
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x7e8569cbe4c6856f, ; from name: aot-AracSayar
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8e25264dda038d5f, ; from name: AracSayar.so
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb961721a78e6c83f, ; from name: aot-AracSayar.so
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc86e49dc97ccc76f, ; from name: aot-AracSayar.dll.so
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf0a149792a209adf, ; from name: libaot-AracSayar.dll.so
		i64 u0xf0a149792a209adf, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-AracSayar.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.aracsayar\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [24 x i8] c"libaot-AracSayar.dll.so\00", align 16
